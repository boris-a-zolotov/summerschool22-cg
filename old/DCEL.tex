...
\end{itemize} \begin{center} \begin{tikzpicture}[scale=0.56,draw=dcelcolor]
   ...
   \bsobl{
	...
	\draw[FireBrick!60!white,<->] (s1) to[out=90,in=150] (s2);
	\draw[FireBrick!60!white,<->] (m1) to[out=255,in=50] (2.5,1.5);
	\draw[FireBrick!60!white,<->] (vn) to[out=-150,in=-60] (vn4);
	\draw[rotate=-7.1,FireBrick!60!white,<->] (m2) .. controls ++(2,1.2) and ++(-2,1.2) .. (m2);
...
\begin{center} \begin{tikzpicture}[scale=0.56,draw=dcelcolor]
	...
	\draw[FireBrick!60!white,<->] (vn2) to[bend left] (ve1);
	\draw[FireBrick!60!white,<->] (vn2) to[bend right] (ve2);
	\draw[FireBrick!60!white,<->] (ns1) to[bend left] (ns2);
